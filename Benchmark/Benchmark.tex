...
\begin{figure}[h]
	\centering
	\subfloat[Compression ratios]{\includegraphics[width=0.5\textwidth]{../Benchmark/img/evalLit/ratios_dog}\label{}}
	\hfill
	\subfloat[Relative amounts of literals]{\includegraphics[width=0.5\textwidth]{img/evalLit/litPerc_dog}\label{}}
...
\begin{figure}[h]
	...
	\subfloat[Compression ratios]{\includegraphics[width=0.5\textwidth]{../Benchmark/img/evalLit/ratios_dog}\label{}}
	\hfill
	\subfloat[Average Length of Literals literals]{\includegraphics[width=0.5\textwidth]{img/evalLit/litLength_dog}\label{}}
