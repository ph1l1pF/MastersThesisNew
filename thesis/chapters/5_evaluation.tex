...
Tab.~\ref{tab:dictImproveDatasets} shows the datasets which were used for evaluating the dictionary improvements. $ELR$ and $SPS$ are not shown here, since they are not relevant for the dictionary compression.
...
\begin{center}
	\begin{tabular}{|c|c|c|c|}
		...
		\hline
	\end{tabular} 
	\captionof{table}{RDF files for the dictionary improvements. URLs to the datasets are in Ch.~\ref{sec:implementationDatasets}.}	
	\label{tab:dictImproveDatasets}
\end{center}
