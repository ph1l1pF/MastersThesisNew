...
\begin{figure}
	...
	\caption{A hyper graph as defined in~\cite{maneth}. The black nodes 1 and 3 are external nodes whereas the white node 2 is internal. $e_3$ (with the label A) is a hyper edge.}
